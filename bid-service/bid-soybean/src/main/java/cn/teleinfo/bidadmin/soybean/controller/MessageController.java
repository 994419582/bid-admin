...
import cn.teleinfo.bidadmin.soybean.wrapper.MessageWrapper;
import cn.teleinfo.bidadmin.soybean.service.IMessageService;
...
public class MessageController extends BladeController {
	...
	*/
	...
	public R remove(@ApiParam(value = "主键集合", required = true) @RequestParam String ids) {
		return R.status(messageService.deleteLogic(Func.toIntList(ids)));
	}
