...
import cn.teleinfo.bidadmin.app.mapper.HelpMapper;
...
public class HelpServiceImpl extends BaseServiceImpl<HelpMapper, Help> implements IHelpService {
	...
	@Override
	public IPage<HelpVO> selectHelpPage(IPage<HelpVO> page, HelpVO help) {
		return page.setRecords(baseMapper.selectHelpPage(page, help));
	}
