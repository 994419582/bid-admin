...
import cn.teleinfo.bidadmin.app.mapper.UserPhotoMapper;
...
public class UserPhotoServiceImpl extends ServiceImpl<UserPhotoMapper, UserPhoto> implements IUserPhotoService {
	...
	@Override
	public IPage<UserPhotoVO> selectUserPhotoPage(IPage<UserPhotoVO> page, UserPhotoVO userPhoto) {
		return page.setRecords(baseMapper.selectUserPhotoPage(page, userPhoto));
	}
