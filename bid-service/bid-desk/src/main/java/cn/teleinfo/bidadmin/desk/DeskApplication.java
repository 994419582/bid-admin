 ...
 */
package cn.teleinfo.bidadmin.desk;
...
@MapperScan("cn.teleinfo.bidadmin.desk.mapper")
public class DeskApplication {

	public static void main(String[] args) {
		CommonApplication.run(AppConstant.APPLICATION_DESK_NAME, DeskApplication.class, args);
	}
