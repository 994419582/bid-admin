 ...
 */
@Service
public class TopsServiceImpl extends ServiceImpl<TopsMapper, Tops> implements ITopsService {

	@Override
	public IPage<TopsVO> selectTopsPage(IPage<TopsVO> page, TopsVO tops) {
		return page.setRecords(baseMapper.selectTopsPage(page, tops));
	}
