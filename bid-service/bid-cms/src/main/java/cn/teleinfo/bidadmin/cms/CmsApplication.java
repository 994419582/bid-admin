 ...
 */
package cn.teleinfo.bidadmin.cms;
...
@MapperScan("cn.teleinfo.bidadmin.cms.mapper")
public class CmsApplication {

	public static void main(String[] args) {
		CommonApplication.run(AppConstant.APPLICATION_CMS_NAME, CmsApplication.class, args);
	}
