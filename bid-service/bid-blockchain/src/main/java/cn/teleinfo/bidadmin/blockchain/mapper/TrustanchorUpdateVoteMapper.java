 ...
 * @since 2019-10-29
 */
public interface TrustanchorUpdateVoteMapper extends BaseMapper<TrustanchorUpdateVote> {
	 ...
	 * @return
	 */
	List<TrustanchorUpdateVoteVO> selectTrustanchorUpdateVotePage(IPage page, TrustanchorUpdateVoteVO trustanchorUpdateVote);
