...
@RestController
@AllArgsConstructor
@RequestMapping("/trustanchormanage")
@Api(value = "", tags = "接口")
public class TrustanchorManageController extends BladeController {
	...
	*/
	...
	@ApiOperation(value = "分页", notes = "传入trustanchorManage")
	public R<IPage<TrustanchorManageVO>> page(TrustanchorManageVO trustanchorManage, Query query) {
		IPage<TrustanchorManageVO> pages = trustanchorManageService.selectTrustanchorManagePage(Condition.getPage(query), trustanchorManage);
		return R.data(pages);
	}
	...
	*/
	...
	@ApiOperation(value = "新增", notes = "传入trustanchorManage")
	public R save(@Valid @RequestBody TrustanchorManage trustanchorManage) {
		return R.status(trustanchorManageService.save(trustanchorManage));
	}
	...
	*/
	...
	@ApiOperation(value = "修改", notes = "传入trustanchorManage")
	public R update(@Valid @RequestBody TrustanchorManage trustanchorManage) {
		return R.status(trustanchorManageService.updateById(trustanchorManage));
	}
	...
	*/
	...
	@ApiOperation(value = "新增或修改", notes = "传入trustanchorManage")
	public R submit(@Valid @RequestBody TrustanchorManage trustanchorManage) {
		return R.status(trustanchorManageService.saveOrUpdate(trustanchorManage));
	}
	...
	*/
	...
	public R remove(@ApiParam(value = "主键集合", required = true) @RequestParam String ids) {
		return R.status(trustanchorManageService.removeByIds(Func.toIntList(ids)));
	}
