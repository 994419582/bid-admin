...
import cn.teleinfo.bidadmin.blockchain.mapper.BlockMapper;
...
public class BlockServiceImpl extends ServiceImpl<BlockMapper, Block> implements IBlockService {
	...
	@Override
	public IPage<BlockVO> selectBlockPage(IPage<BlockVO> page, BlockVO block) {
		return page.setRecords(baseMapper.selectBlockPage(page, block));
	}

	@Override
	public Integer findLastNumber() {
		return baseMapper.findLastNumber();
	}
