...
import cn.teleinfo.bidadmin.blockchain.mapper.EventsMapper;
...
public class EventsServiceImpl extends ServiceImpl<EventsMapper, Events> implements IEventsService {
	...
	@Override
	public IPage<EventsVO> selectEventsPage(IPage<EventsVO> page, EventsVO events) {
		return page.setRecords(baseMapper.selectEventsPage(page, events));
	}
