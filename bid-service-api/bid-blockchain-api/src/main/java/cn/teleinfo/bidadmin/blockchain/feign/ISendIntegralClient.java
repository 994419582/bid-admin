...
@FeignClient(
	...
	fallback = ISendIntegralClientFallback.class
)
public interface ISendIntegralClient {
	String API_PREFIX = "/front/blockchain/";
	/**
	 * 获取加入我们列表
	 *
	 *
	...
	R sendIntegral(@RequestParam("bid") String bid);
